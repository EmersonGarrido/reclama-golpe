...
export default function ProfilePage() {
  ...
  const handlePasswordSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const token = localStorage.getItem('token')
      const response = await fetch('http://localhost:3333/users/password', {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <form onSubmit={handleProfileSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <p className="text-sm text-gray-600 mb-2">URL do Avatar (use Gravatar ou outro serviço)</p>
                      <input
                        type="url"
            ...
            {activeTab === 'danger' && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-6">Zona de Perigo</h2>
                ...
                <div className="border border-red-200 rounded-lg p-6 bg-red-50">
                  ...
                  <p className="text-red-700 mb-4">
                    Ao desativar sua conta, todos os seus dados serão mantidos mas você não poderá mais acessar a plataforma. 
