...
# ================================================================
# Reclama Golpe - API Only Deployment Script
# ================================================================
# This script deploys only the API backend
# ================================================================
...
# Setup PM2 for API only
setup_pm2() {
    log_info "Setting up PM2 for API..."
    ...
    log_success "PM2 configured and API started"
}
...
#!/bin/bash
# Backup script for Reclama Golpe API
...
create_systemd_service() {
    ...
    cat > /etc/systemd/system/reclamagolpe-api.service <<EOF
[Unit]
Description=Reclama Golpe API
...
ExecStart=/usr/bin/pm2 start ${INSTALL_PATH}/ecosystem-api.config.js
...
EOF
    ...
    systemctl enable reclamagolpe-api.service
...
# Main execution
main() {
    log_info "Starting Reclama Golpe API deployment..."
    ...
    log_success "  - Restart: pm2 restart reclamagolpe-api"
    log_success ""
    ...
    log_warning "  2. Configure your frontend to use this API endpoint"
